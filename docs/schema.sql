...
-- Started on 2026-08-11 20:43:48 JST
...
--
-- TOC entry 853 (class 1247 OID 25426)
...
--
-- TOC entry 856 (class 1247 OID 25451)
...
--
-- TOC entry 219 (class 1259 OID 25384)
...
--
-- TOC entry 218 (class 1259 OID 24936)
...
CREATE TABLE public.orders (
    ...
    created_at timestamp with time zone DEFAULT now(),
    total numeric(10,2) DEFAULT 1 NOT NULL,
...
--
-- TOC entry 3494 (class 2604 OID 24895)
...
--
-- TOC entry 3498 (class 2604 OID 24922)
...
--
-- TOC entry 3489 (class 2604 OID 24885)
...
--
-- TOC entry 3485 (class 2604 OID 24873)
...
--
-- TOC entry 3521 (class 2606 OID 25388)
...
--
-- TOC entry 3511 (class 2606 OID 24901)
...
--
-- TOC entry 3513 (class 2606 OID 24899)
...
--
-- TOC entry 3515 (class 2606 OID 24907)
...
--
-- TOC entry 3517 (class 2606 OID 24927)
...
--
-- TOC entry 3519 (class 2606 OID 25468)
-- Name: order_items pk_order_items; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.order_items
    ADD CONSTRAINT pk_order_items PRIMARY KEY (orders_id, product_id);


--
-- TOC entry 3509 (class 2606 OID 24890)
...
--
-- TOC entry 3505 (class 2606 OID 24880)
...
--
-- TOC entry 3507 (class 2606 OID 24878)
...
--
-- TOC entry 3523 (class 2606 OID 24908)
...
--
-- TOC entry 3524 (class 2606 OID 24913)
...
--
-- TOC entry 3522 (class 2606 OID 25462)
-- Name: products fk_user_id_products; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.products
    ADD CONSTRAINT fk_user_id_products FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- TOC entry 3526 (class 2606 OID 24944)
...
--
-- TOC entry 3527 (class 2606 OID 24949)
...
--
-- TOC entry 3525 (class 2606 OID 24930)
...
-- Completed on 2026-08-11 20:43:49 JST
